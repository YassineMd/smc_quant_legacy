...
_M10_STRATEGIES = [
    ...
    ("m10_wallsurge", "Wall Surge (▲▼ · strong Δ + kept≥80% @ 30m wall · 1m·5m clock)", False, True),  # 1m/5m CLOCK only: pane-STRONG |delta| (trailing-50 pct ≥ P80) AND Eff/Res retention ≥ 80% (kept its delta-direction excursion) inside a same-side 30m wall/radar area — strong held buying on a support wall ▲ / strong held selling on a resistance wall ▼. Descriptive/eyeball, no tested edge
