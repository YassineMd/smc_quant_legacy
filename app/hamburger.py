...
_M10_STRATEGIES = [
    ...
    ("m10_bigbar", "ꕻ Big Bar (Time candles · green L / red S)", False, True),  # candle size in the TOP THIRD of the last 4 finished EMA-trend segments' sizes (the E/E/C window applied to SIZE, causal at flip confirmation); clock/time source only, all tf
