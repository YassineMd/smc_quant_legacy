...
_M10_STRATEGIES = [
    ...
    ("m10_wallsurge", "Wall Surge (▲▼ · strong Δ @ 30m wall · 1m clock)", False, True),  # 1m CLOCK only: pane-STRONG |delta| (trailing-50 pct ≥ P80) inside a same-side 30m wall/radar area — strong buying on a support wall ▲ / strong selling on a resistance wall ▼. Descriptive/eyeball, no tested edge
