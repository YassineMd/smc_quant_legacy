...
_M10_STRATEGIES = [
    ...
    ("m10_bigbar", "ꕻ Big Bar (Time candles · green L / red S)", False, True),  # candle size > P90 (config.BIGBAR_SIZE_PCTL) of the last 4 finished EMA-trend segments' candle sizes (rank-based, causal at flip confirmation); clock/time source only, all tf
