...
_M10_INDICATORS = [
    ...
    ("m10_sessbub", "Bubble @Level (yellow)", False, True),   # EYEBALL-ONLY: confirming aggressive bubble at a prior-session level (Tokyo/London H/L/POC); yellow area. NOT a signal — 88% rejection is RR geometry
