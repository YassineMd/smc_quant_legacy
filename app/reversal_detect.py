...
# GOLD tier = the approach into the extreme was CHOPPY (<= this many consecutive same-direction candles), not a
# straight-down/up crash. Robust both tf + both years: choppy approach reverses ~42% vs a straight run ~36% (base ~18%).
# study/reversal_longwindow_15m.py + the 1h check. (The old tighter cir/wick/ds 'strong' didn't lift precision.)
STRONG_RUN_MAX = 2
